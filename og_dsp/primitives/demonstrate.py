...
import og_dsp
from og_dsp.utils import EM, F1, DPR_normalize, dotdict, has_answer, normalize_text
...
#     rng = random.Random(og_dsp.settings.branch_idx)
...
def knn(
    ...
    **knn_args,
    ...
    """
    from og_dsp.utils.ann_utils import create_faiss_index
