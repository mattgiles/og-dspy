...
class UnderstandTask(og_dspy.Signature):
    ...
    task_description = og_dspy.InputField(
        prefix="Task Description:",
        desc="Description of the task.",
    )
    explanation = og_dspy.OutputField(
        prefix="Task Description:",
        desc="Explanation of the task.",
    )

class ExplainTask(og_dspy.Signature):
...
class UpdateTaskDescriptionBasedOnFeedback(og_dspy.Signature):
    ...
    feedback = og_dspy.InputField(
        prefix="Feedback:",
        desc="Feedback on the task description.",
    )
    updated_task_description = og_dspy.OutputField(
        prefix="Task Description:",
        desc="Updated description of the task.",
    )

class GetFeedbackOnGeneration(og_dspy.Signature):
    ...
    synthetic_data = og_dspy.InputField(
    ...
    feedback = og_dspy.OutputField(
        prefix="Feedback:",
        desc="Feedback on the synthetic data.",
    )

class GenerateFieldDescription(og_dspy.Signature):
    ...
    field_name = og_dspy.InputField(
        prefix="Field Name:",
        desc="Name of the field to generate synthetic data for.",
    )
    field_description = og_dspy.OutputField(
        prefix="Field Description:",
        desc="Description of the field.",
    )

class GenerateInputFieldsData(og_dspy.Signature):
...
A knowledge seed is the index of the knowledge base you have, each index represents a different knowledge base."""
    ...
    knowledge_seed = og_dspy.InputField(
...
class GenerateOutputFieldsData(og_dspy.Signature):
    pass
