...
import og_dsp
from og_dspy.signatures.signature import signature_to_template

from .bootstrap import BootstrapFewShot

# from og_dspy.primitives import Example
from .teleprompt import Teleprompter

# from .vanilla import LabeledFewShot

# from og_dspy.evaluate.evaluate import Evaluate
...
class BootstrapFinetune(Teleprompter):
    ...
    def compile(
        ...
        *,
        ...
        from og_dsp.modules.finetuning import finetune_hf
