from og_dspy.teleprompt.mipro_optimizer import MIPRO
...
from og_dspy.teleprompt import BayesianSignatureOptimizer
...
* task_model: The model used for prompt generation. When unspecified, defaults to the model set in settings (ie. og_dspy.settings.configure(lm=task_model)).
